...
// ===================================
// PRODUCT SEO CLUSTER PANEL
// ===================================

class ProductSeoClusterPanel {
    constructor() {
    ...
    init() {
        ...
        // Keep the contextual links in the document flow so they never cover
        // product photos, specifications, or the quote box while scrolling.
        this.panel.classList.remove('seo-cluster-floating', 'seo-cluster-mobile-tabbar', 'is-minimized', 'is-expanded');
        document.body.classList.remove('has-mobile-seo-cluster-tabbar');
    }
}
...
class WhatsAppFloatingButton {
    ...
    init() {
        ...
        button.setAttribute('aria-label', 'Bize WhatsApp ile ulaşın');
        ...
        button.innerHTML = `
            ...
            <span class="whatsapp-float-label">Bize WhatsApp ile ulaşın</span>
        `;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try { new ProductSeoClusterPanel(); } catch (e) { console.debug('ProductSeoClusterPanel not active on this page'); }
